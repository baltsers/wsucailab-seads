...
rm -R out-ODDStaticGraph -f
mkdir -p out-ODDStaticGraph



SOOTCP=".:$subjectloc/bin:$ROOT/SEADS.jar"
...
cp $subjectloc/ODDStaticGraph/staticVtg.dat $subjectloc/staticVtg.dat
cp $subjectloc/ODDStaticGraph/staticVtg.dat $subjectloc/SEADSInstrumented/staticVtg.dat
# rm *.class
