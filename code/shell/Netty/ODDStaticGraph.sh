...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/java:$subjectloc/4119:$ROOT/SEADS.jar"
...
java -Xmx40g -ea -cp ${MAINCP} ODD.ODDStaticGraph \
	-w -cp ${SOOTCP} \
	...
	-dumpFunctionList \
	-serializeVTG \
	 1>out-ODDG/instG.out 2>out-ODDG/instG.err
