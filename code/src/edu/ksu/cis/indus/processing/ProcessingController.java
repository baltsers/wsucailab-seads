...
public class ProcessingController {
	...
	public final void process() {
		...
		System.out.println("_processors.size()="+_processors.size());
		...
		System.out.println("processStmts="+processStmts+" processValues="+processValues+" env.getClasses().size()="+env.getClasses().size());
...
//					if (_stmt!=null && stmtSwitcher!=null)
