...
/**
 * This class provides monitor information about the application. It provides
 * information such the monitors in the application, monitor enclosure
 * information, and even a monitor graph.
 * 
 * @author <a href="http://www.cis.ksu.edu/~rvprasad">Venkatesh Prasad Ranganath</a>
 * @author $Author: rvprasad $
 * @version $Revision: 1.33 $
 */
public final class MonitorAnalysis extends AbstractAnalysis implements
        IMonitorInfo<SimpleNode<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>> {

    /**
     * This represents monitor enclosure as a graph with each monitor
     * represented as a node and an edge representing that the monitor of the
     * source node encloses the monitor of the destination node.
     * 
     * @author <a href="http://www.cis.ksu.edu/~rvprasad">Venkatesh Prasad
     *         Ranganath</a>
     * @author $Author: rvprasad $
     * @version $Revision: 1.33 $ $Date: 2007/02/10 19:07:14 $
     */
    private class MonitorGraph extends SimpleNodeGraph<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> implements
            IMonitorInfo.IMonitorGraph<SimpleNode<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>> {
         ...
         * {@inheritDoc}
         * 
         * @see edu.ksu.cis.indus.interfaces.IMonitorInfo.IMonitorGraph#getInterProcedurallyEnclosedStmts(Triple,
         *      boolean)
         */
        ...
        /**
         * Calculates the immediate monitor triples enclosing the call site that
         * invokes the given method.
         * 
         * @param method of interest.
         */
        private Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> calculateImmediateInterprocedurallyEnclosingMonitorTriples(
        ...
        /**
         * This helps <code>getInterProcedurallyEnclosedStmts</code> methods
         * to calculate enclosures.
         * 
         * @param method of interest.
         * @param transitive <code>true</code> if transitive closure is
         *            required; <code>false</code>, otherwise.
         * @param method2stmts an out parameter in which each method will be
         *            mapped to a set of statements.
         * @param stmtsWithInvokeExpr is an iterator over statements with invoke
         *            expresssions.
         * @pre method != null
            ...
            while (_wb.hasWork()) {
                ...
                for (int _iIndex = 0; _iIndex < _iEnd; _iIndex++) {
                    ...
                    if (!_callee.isSynchronized() || (_callee.isSynchronized() && transitive)) {
                        ...
                        for (final Stmt _s : IteratorUtils.filteredIterable(_stmts,
        ...
        /**
         * Retrieves the statements enclosed in the monitor of the synchronized
         * method. This retrieves inter procedural enclosures.
         * 
         * @param monitorStmt of interest.
         * @param method of interest.
         * @param transitive <code>true</code> if transitive closure is
         *            required; <code>false</code>, otherwise.
         * @return a map from methods to statements in them that occur in the
         *         enclosure.
         * @pre method != null and monitorStmt != null
         * @post result != null
         */
        private Map<SootMethod, Collection<Stmt>> getInterProcedurallyEnclosedStmts(final MonitorStmt monitorStmt,
         ...
         *         enclosure.
         * @pre method != null
         * @post result != null and result.oclIsKindOf(Map(SootMethod,
         *       Collection(Stmt)))
         */
    ...
    /**
     * This the preprocessor which captures the synchronization points in the
     * system.
     * 
     * @author <a href="http://www.cis.ksu.edu/~rvprasad">Venkatesh Prasad
     *         Ranganath</a>
     ...
     * @version $Revision: 1.33 $
     */
    private final class PreProcessor extends AbstractProcessor {

        /**
         * Preprocesses the given method. It records if the method is
         * synchronized. * {@inheritDoc}
         * 
        ...
        /**
         * Preprocesses the given stmt. It records if the <code>stmt</code> is
         * an enter/exit monitor statement.
         * 
         * @param stmt is the enter/exit monitor statement.
         * @param context in which <code>stmt</code> occurs. This contains the
         *            method that encloses <code>stmt</code>.
        ...
        public void callback(final Stmt stmt, final Context context) {
            if (stmt instanceof EnterMonitorStmt) {
                MapUtils.putIntoSetInMap(method2enterMonitors, context.getCurrentMethod(), (EnterMonitorStmt) stmt);
            }
        }
    ...
    /**
     * This is the approximate number of synchronized methods in the
     * application.
     */
    static final int NUM_OF_SYNCED_METHODS_IN_APPLICATION = 50;

    /**
     * This maps methods to a map from statements to the immediately enclosing
     * monitor statements.
     */
    ...
    final Map<SootMethod, Map<Unit, Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>>> method2enclosedUnits2monitors = new HashMap<SootMethod, Map<Unit, Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>>>(
            Constants.getNumOfMethodsInApplication());
    /**
     * This collects the enter-monitor statements in each method during
     * preprocessing. This is used during analysis only.
     */
    final Map<SootMethod, Collection<EnterMonitorStmt>> method2enterMonitors = new HashMap<SootMethod, Collection<EnterMonitorStmt>>(
            Constants.getNumOfMethodsInApplication());

    /**
     * This maps methods to a map from monitor statements to the immediately
     * enclosed statements.
     */
    ...
    /**
     * This is collection of monitor triples that occur in the analyzed system.
     * The elements of the triple are of type <code>EnterMonitorStmt</code>,
     * <code>ExitMonitorStmt</code>, and <code>SootMethod</code>,
     * respectively.
     * 
     * @invariant monitorTriples->forall(o | o.getFirst() == null and
     *            o.getSecond() == null implies o.getThird().isSynchronized())
     */
    ...
    /**
     * This maps synchronized methods to the collection of statements in them
     * that are synchronization dependent on the entry and exit points of the
     * method.
     */
    ...
    /**
     * Calculates the synchronization dependency information for the methods
    ...
    public void analyze() {
        unstable();
        //System.out.println("MonitorAnalysis analyze0()");
        if (LOGGER.isInfoEnabled()) {
            LOGGER.info("BEGIN: Monitor Analysis processing");
        }
        //System.out.println("MonitorAnalysis analyze1() monitorTriples.size()="+monitorTriples.size());
       // System.out.println("MonitorAnalysis analyze1() syncedMethods.size()="+syncedMethods.size());
        ...
        /*
         * Calculating monitor info is not as simple as it looks in the presence
         * of exceptions. The exit monitors are the tricky ones. The exit
         * monitors are guarded by catch block generated by the compiler. The
         * user cannot generate such complex catch blocks, but nevertheless we
         * cannot assume about the compiler. So, we proceed by calculating the
         * monitor info over a complete unit graph and use object flow
         * information to arbitrate suspicious enter-exit matches.
         */
        //System.out.println("MonitorAnalysis analyze1() Constants.getNumOfMethodsInApplication()="+Constants.getNumOfMethodsInApplication());
        //System.out.println("MonitorAnalysis analyze1() method2enterMonitors.size()="+method2enterMonitors.size());
...
//				}
	            if (method.isSynchronized()) {
	            	//System.out.println("---------- method.isSynchronized()= "+method);
	                syncedMethods.add(method);	                
	            }
	            try 
	            {
					Iterator<Unit> units=method.retrieveActiveBody().getUnits().iterator();
					//System.out.println("units="+units);
					Collection<EnterMonitorStmt> methodSt=new HashSet<EnterMonitorStmt>();
					EnterMonitorStmt enterSt=null;
					ExitMonitorStmt exitSt=null;
					while(units.hasNext())
					{
						try
						{
				            ...
				            if (st instanceof EnterMonitorStmt) {
				            	enterSt=(EnterMonitorStmt) st;
				            	methodSt.add(enterSt);		            	
				            }
				            else if (st instanceof ExitMonitorStmt) {
				            	exitSt=(ExitMonitorStmt) st;       	
				            }
			            }
			            catch (Exception _e)
			            {
			            	//ystem.out.println("Exception: "+_e);
			            }
					}
					final Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod> _triple = new Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>(
	                        enterSt, exitSt, method);
	                _triple.optimize();
	                monitorTriples.add(_triple);
					method2enterMonitors.put(method, methodSt);
	            }
	            catch (Exception _e)
	            {
	            	//ystem.out.println("Exception: "+_e);
...
//    //_processedMonitors
//        System.out.println("MonitorAnalysis analyze1() _processedMonitors.size()="+_processedMonitors.size());
...
//        System.out.println("MonitorAnalysis analyze1() _processedMonitors.size()="+_processedMonitors.size());
//        System.out.println("MonitorAnalysis analyze1() _processedMonitors="+_processedMonitors);
        //method2enterMonitors.clear();
        stable();
    ...
    public Collection<Stmt> getEnclosedStmts(final Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod> monitorTriple,
        ...
        if (_enterMonitorStmt == null) {
            ...
            if (transitive && !_result.isEmpty()) {
                ...
                for (int _iIndex = 0; _iIndex < _iEnd; _iIndex++) {
                    final EnterMonitorStmt _monitorStmt = (EnterMonitorStmt) _i.next();
                    final Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> _monitorTriplesFor = getMonitorTriplesFor(
                            _monitorStmt, _sm);
            ...
            if (!_monitor2enclosedStmts.isEmpty()) {
                if (transitive) {
                    ...
                    _result
                            .addAll(MapUtils
                                    .getFromMap(_monitor2enclosedStmts, monitorTriple, Collections.<Stmt> emptyList()));
                }
            }
        }
        return _result;
     ...
     * {@inheritDoc}
     * 
     * @see edu.ksu.cis.indus.interfaces.IMonitorInfo#getEnclosingMonitorStmts(soot.jimple.Stmt,
     *      soot.SootMethod, boolean)
     */
     ...
     * {@inheritDoc}
     * 
     * @see edu.ksu.cis.indus.interfaces.IMonitorInfo#getEnclosingMonitorTriples(soot.jimple.Stmt,
     *      SootMethod, boolean)
     */
    public Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> getEnclosingMonitorTriples(final Stmt stmt,
            final SootMethod method, final boolean transitive) {
        final Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> _result = new HashSet<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>();
        final Map<Stmt, Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>> _enclosedStmt2monitors = MapUtils
                .getEmptyMapFromMap(method2enclosedStmts2monitors, method);
    ...
    public IMonitorGraph<SimpleNode<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>> getMonitorGraph(
        ...
        // we use a backward search on the call graph to construct the monitor
        // graph.
        for (int _iIndex = 0; _iIndex < _iEnd; _iIndex++) {
            final Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod> _monitor = _i.next();
     ...
     * {@inheritDoc}
     * 
     * @see edu.ksu.cis.indus.interfaces.IMonitorInfo#getMonitorTriplesFor(soot.jimple.MonitorStmt,
     *      SootMethod)
     */
    public Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> getMonitorTriplesFor(
            final MonitorStmt monitorStmt, final SootMethod method) {
        final Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> _result = new HashSet<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>();
    ...
    public Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> getMonitorTriplesOf(
        ...
        if (monitor.getFirst() == null) {
            ...
            for (int _iIndex = 0; _iIndex < _iEnd; _iIndex++) {
                final MonitorStmt _stmt = _i.next();
...
//    }
    public Collection<Stmt> getUnenclosedStmtsOf(final SootMethod method) {
    	Collection<Unit> _resultUnit = getUnenclosedUnitsOf(method);
    	Collection<Stmt> _result= MapUtils.getEmptyMapFromMap(method2enclosedStmts2monitors, method).keySet();
    	_result.clear();
    	{
    ...
    public Collection<Unit> getUnenclosedUnitsOf(final SootMethod method) {
        final Collection<Unit> _enclosedUnits = MapUtils.getEmptyMapFromMap(method2enclosedUnits2monitors, method).keySet();
        final IPredicate<Unit> _predicate = new IPredicate<Unit>() {

            public boolean evaluate(final Unit o) {
                return !_enclosedUnits.contains(o);
            }
        };

        final Collection<Unit> _result = IteratorUtils.toList(IteratorUtils.<Unit, Unit> filteredIterator(
                getUnitGraph(method).iterator(), _predicate));
        return _result;
    }
    /**
    ...
    public void reset() {
        ...
        method2enclosedUnits2monitors.clear();
    ...
    // /CLOVER:OFF
    /**
     * Returns a stringized representation of this analysis. The representation
     ...
     * {@inheritDoc}
     * 
     * @throws InitializationException when object flow analysis is not
     *             provided.
     * @pre info.get(OFAnalyzer.ID) != null and
     *      info.get(OFAnalyzer.ID).oclIsTypeOf(OFAnalyzer)
     * @pre info.get(PairManager.ID) != null and
     *      info.get(PairManager.ID).oclIsTypeOf(PairManager)
    ...
    protected void setup() throws InitializationException {
        ...
        if (ofa == null) { throw new InitializationException(IValueAnalyzer.ID + " was not provided in the info."); }

        pairMgr = (PairManager) info.get(PairManager.ID);

        if (pairMgr == null) { throw new InitializationException(PairManager.ID + " was not provided in the info."); }
    }

    /**
     * Adds edges from the given sources to the given destination (all-to-all)
     * in the given graph.
     * 
     * @param srcs is the collection of enclosing monitors.
     * @param dests is the collection of nodes corresponding to enclosed
     *            monitors.
     * @param graph is the monitor graph being constructed.
     * @pre srcs != null and dests != null and graph != null
     * @post srcs->forall(o | graph.queryNode(o ) != null) and dests->forall(o |
     *       graph.queryNode(o) != null)
     * @post srcs->forall(o | dests->forall(p |
     *       graph.queryNode(o).getSuccsOf()->contains(graph.queryNode(p))))
     */
    private void addEdgesFromToIn(final Collection<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>> srcs,
            final Collection<SimpleNode<Triple<EnterMonitorStmt, ExitMonitorStmt, SootMethod>>> dests,
            final MonitorGraph graph) {
    ...
    /**
     * Calculates the transitive closure of enclosing monitor for the given
     * statement based in the given map.
     * 
     * @param monitor2stmts maps a statement to it's immediately enclosing
     *            intraprocedural monitor.
     ...
     * statement based in the given map.
     * 
     * @param stmt2monitors maps a statement to it's immediately enclosing
     *            intraprocedural monitor.
    ...
    /**
     * Populates the work bag with work to proecess the successors of the given
     * basic block.
     * 
     * @param workbag to populate.
     * @param exitBasicBlock is the basic blocks whose successors need to be
     *            processed.
     * @param enterStack is the stack of enter monitors.
     * @param currStmts is collection of current statement matched to the
     *            topmost monitor.
     * @pre workbag != null and exitBasicBlock != null nad enterStack != null
     *      and currStmts != null
     */
    private void populateWorkBagToProcessSuccessors(
        ...
        if (_succs.size() == 1) {
            ...
            for (final Iterator<BasicBlock> _j = _succs.iterator(); _j.hasNext();) {
                ...
                workbag.addWork(_quadraple);
            }
        }
    }

    /**
     * Populates the work bag with work to precess the basic blocks containing
     * the given exit montiors or their successors.
     * 
     * @param workbag to populate.
     * @param exitMonitors is the collection of exit monitors whose basic block
     *            should be processed.
     * @param enterStack is the stack of enter monitors.
     * @param currStmts is collection of current statement matched to the
     *            topmost monitor.
     * @param graph is the basic block graph.
     * @pre workbag != null and exitMonitors != null and enterStack != null and
     *      currStmts != null and graph != null
     */
    private void populateWorkBagWithSuccessorsOfNestedMonitor(
        ...
        for (final Iterator<ExitMonitorStmt> _k = exitMonitors.iterator(); _k.hasNext();) {
            ...
            // as we are short circuiting, remember to add the exit monitor stmt
            // of the monitor we just skipped to the
     ...
     * @param enter2exits maps enter monitors in the method to a collection of
     *            exit monitors.
     * @param enterStack is the stack of enter monitors.
     * @param currStmts is collection of current statement matched to the
     *            topmost monitor.
     * @param exitMonitor is the exit monitor to be processed.
     * @return a collection of statements enclosed in the monitor corresponding
     *         to <code>exitMonitor</code>.
     * @pre method != null and enter2exits != null and enterStack != null and
     *      currStmts!= null and exitMonitor != null
     */
    private Collection<Stmt> processExitMonitor(final SootMethod method,
        ...
        if (shouldCollectInfo(method, _enter, _exit)) {
            ...
            // load up the statements in the enclosing critical region for
            // processing
     ...
     * 
     * @param processedMonitors is the collection of monitors which have been
     *            processed.
     ...
     * @pre method != null and enter2exits != null and processedMonitors != null
     *      and enterMonitor != null
    ...
    private Collection<EnterMonitorStmt> processMonitor(final Collection<EnterMonitorStmt> processedMonitors,
        ...
        outerloop: do {
            ...
            for (final Iterator<Stmt> _j = _bb.getStmtsFrom(_leadStmt).iterator(); _j.hasNext();) {
                ...
                /*
                 * We do not employ the usual
                 * "do-not-process-processed-statements" here as in the
                 * following case comm1 and exitmonitor will be processed before
                 * the second entermonitor is processed. bb1: if <cnd> goto bb2
                 * else bb3 bb2: entermonitor r1; goto bb4 bb3: entermontior r1;
                 * goto bb4 bb4: comm1; exitmonitor r1 Hence, we just process
                 * the statements and rely on the enterStack for validity.
                 */
                if (_stmt instanceof EnterMonitorStmt) {
                    ...
                    if (!processedMonitors.contains(_enter)) {
                        // if the monitor was not processed, then hoist the
                        // monitor up for processing.
                        ...
                        // add the current monitor to the list of current
                        // statements
                    ...
                    /*
                     * Although it seems that continuing processing the rest of
                     * the statements in the basic block seems like a efficient
                     * idea, but it fails in the following case if we start
                     * processing the monitor in bb2 bb1: entermonitor r1 bb2:
                     * entermonitor r2 bb3: exitmonitor r2 exitmonitor r1 Hence,
                     * it is safer to end local processing when the monitor
                     * stack is empty.
                     */
                    ...
                    if (!_currStmts.add(_stmt) || (!_enterStack.isEmpty() && _enterStack.peek().getSecond().contains(_stmt))) {
                        /*
                         * If the current statement was already seen then the
                         * path from hereon was traversed earlier. Hence, we can
                         * skip processing the successors.
                         */
                        _skippingSuccs = true;
                        break;
                    }
            ...
            if (!(_skippingSuccs || _enterStack.isEmpty())) {
                // populate the workbag with work depending on the fanout number
    ...
    /**
     * Process the synchronized methods to collect the statements that are
     * enclosed by the monitors at the entry/exit point of the method.
     */
     ...
     * @return <code>true</code> if the given parts do indeed constitute a
     *         monitor; <code>false</code>, otherwise.
    ...
    private boolean shouldCollectInfo(final SootMethod method, final EnterMonitorStmt enter, final ExitMonitorStmt exit) {
        /*
         * if the monitor object at the enter and exit statements contain
         * atleast one common object then consider this pair, if not continue.
         */
