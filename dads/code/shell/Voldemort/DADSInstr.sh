...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/dist2/classes:$ROOT/DADS.jar"
...
OUTDIR=$subjectloc/ODDInstrumented2
mkdir -p $OUTDIR
...
java -Xmx40g -ea -cp ${MAINCP} DADS.DadsInst \
