...
MAINCP="$ROOT/DUA/bin:$ROOT/DADS.jar:$ROOT/libs/soot-trunk.jar"
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/dist/classes:$subjectloc/dist/testclasses:$ROOT/DADS.jar"
...
OUTDIR=$subjectloc/DADSStaticGraph
mkdir -p $OUTDIR
...
cp $subjectloc/DADSStaticGraph/staticVtg.dat .
