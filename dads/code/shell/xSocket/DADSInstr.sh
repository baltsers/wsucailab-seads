...
MAINCP=".:/home/xqfu/libs/soot-trunk.jar:/home/xqfu/DUA/bin:/home/xqfu/DADS.jar"
echo $MAINCP
rm -R out-Instr -f
mkdir -p out-Instr


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/java/bin:$subjectloc/bin:/home/xqfu/DADS.jar"
...
java -Xmx100g -ea -cp ${MAINCP} DADS.DadsInst \
	-w -cp ${SOOTCP} \
...
cp version.txt $subjectloc/DADSInstrumented/org/xsocket/. -f
