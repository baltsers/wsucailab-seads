/**
 * File: src/Dads/DadsInst.java
 * -------------------------------------------------------------------------------------------
 * Date			Author      Changes
 * -------------------------------------------------------------------------------------------
 * 03/22/2019	Developer		created; for Dads instrument
*/
package Dads;
...
public class DadsInst extends EAInst {
	...
	@Override public void run() {
		...
		Stmt[] idToS= StmtMapper.getCreateInverseMap();		
	     if (opts.debugOut()) 
	     {
	    	 System.out.println("Running Dads Instrumentation");
	     }
