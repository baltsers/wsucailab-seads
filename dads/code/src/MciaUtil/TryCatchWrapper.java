 ...
 * Date			Author      Changes
 * -------------------------------------------------------------------------------------------
 * 07/05/13		Developer		created, add try...catch(Exception) blocks into a given program entity in Jimple 
 * 08/27/13		Developer		added wrapTryCatchAllBlocks to wrap try...catch(Throwable) and put logging facilities
